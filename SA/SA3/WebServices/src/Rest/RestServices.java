...
@Path("/Rest")
public class RestServices implements WebServices {
    @GET
    ...
    public String sendEmail(
            @FormParam("_url") String _url,
            @FormParam("_payload") String _payload) {
...
//    }
    ...
    @Produces(MediaType.TEXT_PLAIN)
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    public String validateEmailAddress(@FormParam("_url") String _url){
        //名字不包含中文
        String pattern1="^[a-zA-Z.0-9_-]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$";
        //名字包含中文
